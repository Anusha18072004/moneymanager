...
import in.anusha.moneymanager.dto.AuthDTO;
import in.anusha.moneymanager.dto.ProfileDTO;
import in.anusha.moneymanager.entity.ProfileEntity;
import in.anusha.moneymanager.repository.ProfileRepository;
import in.anusha.moneymanager.util.JwtUtil;
...
public class ProfileService {
    ...
    public ProfileDTO registerProfile(ProfileDTO profileDTO) {
        ...
        String activationLink = "http://localhost:8084/api/v1.0/activate?token=" + newProfile.getActivationToken();
