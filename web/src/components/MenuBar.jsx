...
const MenuBar = ({ activeMenu }) => {
    ...
    return (
        <div className="flex items-center justify-between gap-5 bg-indigo-50 border border-b border-gray-200/50 backdrop-blur-[2px] py-4 px-4 sm:px-7 sticky top-0 z-30">
            ...
            <div className="relative" ref={dropdownRef}>
                <button
                    ...
                    className="flex items-center justify-center w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-800 focus:ring-offset-2">
