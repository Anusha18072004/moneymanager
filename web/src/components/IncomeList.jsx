        ...
        <div className="card p-4 mt-6">
            ...
            {incomes.length === 0 ? (
                ...
                <div className="space-y-4">
                    {incomes.map((income) => (
                        <div key={income.id} className="flex items-center justify-between bg-gray-50 p-3 rounded-lg hover:bg-gray-100">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 flex items-center justify-center text-xl bg-white rounded-full shadow-sm">
                                    {income.icon ? (
                                        income.icon.includes('http') ? (
                                            <img src={income.icon} alt={income.name} className="w-6 h-6" />
                                        ) : (
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                >
                                    <Trash2 size={18} className="hidden" /> {/* Placeholder for alignment if needed, but using Pencil */}
